...
if (process.platform === 'win32') {
  PLUGIN_LOCAL.paths = [
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Bandisto.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda BeatBox.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Combo.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda De-ess.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Degrade.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Delay.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Detune.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Dither.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda DubDelay.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Dynamics.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Envelope.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Image.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Leslie.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Limiter.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Loudness.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda MultiBand.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Overdrive.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda RePsycho!.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda RezFilter.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda RingMod.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda RoundPan.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Shepard.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Splitter.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Stereo.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda SubSynth.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Talkbox.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda TestTone.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda ThruZero.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda Tracker.dll'),
    path.join('test', 'plugins', 'VST', 'studiorack', 'mda', 'mda', '1.0.4', 'mda VocInput.dll'),

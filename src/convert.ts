...
export interface ConfigInterface {
    ...
    pluginEffectCategories:     { [key: string]: PluginCategory };
    pluginFile:                 string;
    pluginFolder:               string;
    pluginInstrumentCategories: { [key: string]: PluginCategory };
...
export class Convert {
    public static toPluginCategory(json: string): PluginCategory {
        return cast(JSON.parse(json), r("PluginCategory"));
    }

    public static pluginCategoryToJson(value: PluginCategory): string {
        return JSON.stringify(uncast(value, r("PluginCategory")), null, 2);
    }
...
const typeMap: any = {
    ...
    "ConfigInterface": o([
        ...
        { json: "pluginEffectCategories", js: "pluginEffectCategories", typ: m(r("PluginCategory")) },
        { json: "pluginFile", js: "pluginFile", typ: "" },
        { json: "pluginFolder", js: "pluginFolder", typ: "" },
        { json: "pluginInstrumentCategories", js: "pluginInstrumentCategories", typ: m(r("PluginCategory")) },
    ...
    "DAWAudio": o([
        { json: "File", js: "File", typ: r("DAWFileReference") },
    ], false),
    "DAWFileReference": o([
    ...
    "DAWIntegerParameter": o([
    ], false),
    "DAWRealParameter": o([
    ], false),
    "DAWTimeSignatureParameter": o([
    ], false),
    "DAWParameter": o([
    ], false),
    "DAWBuiltinDevice": o([
